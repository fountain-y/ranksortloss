...
CUDA_VISIBLE_DEVICES=6 python -u tools/test.py \
configs/ranksort_loss/ranksort_faster_rcnn_r101_fpn_1x_cell_voc.py \
work_dirs/20211128_ranksort_faster_rcnn_r101_fpn_1x_cell_voc/latest.pth \
--eval mAP \
--show-dir work_dirs/20211128_ranksort_faster_rcnn_r101_fpn_1x_cell_voc/result