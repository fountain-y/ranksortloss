...
classes = ['嗜酸性分叶核粒细胞', '早幼红细胞', '原始浆细胞', '早幼粒细胞', '巨中幼红细胞', '异型淋巴细胞', '巨晚幼红细胞', '中性分叶核粒细胞', '中幼红细胞', '中性晚幼粒细胞', '中性中幼粒细胞', '幼稚淋巴细胞', '幼稚浆细胞', '中性杆状核粒细胞', '幼稚单核细胞', '晚幼红细胞', '原始淋巴细胞', '成熟淋巴细胞', '原始粒细胞', '异常早幼粒细胞', '原始单核细胞']
img_norm_cfg = dict(
